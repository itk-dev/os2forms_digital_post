...
class BilagType extends AbstractStructBase
{
     ...
     * Meta information extracted from the WSDL
     * - base: string
     * - choice: BilagIdentifikator | VedhaeftningIndholdData | VedhaeftningIndholdURLreference | VedhaeftSomIndholdDataIndikator
     * - choiceMaxOccurs: 1
     * - choiceMinOccurs: 1
     * - maxLength: 10
    ...
    public function setBilagIdentifikator(?string $bilagIdentifikator = null): self
    {
        ...
        // validation for constraint: choice(BilagIdentifikator, VedhaeftningIndholdData, VedhaeftningIndholdURLreference, VedhaeftSomIndholdDataIndikator)
    ...
    {
        return isset($this->VedhaeftningIndholdURLreference) ? $this->VedhaeftningIndholdURLreference : null;
    }
    /**
     * This method is responsible for validating the value passed to the setVedhaeftningIndholdURLreference method
     * This method is willingly generated in order to preserve the one-line inline validation within the setVedhaeftningIndholdURLreference method
     * This has to validate that the property which is being set is the only one among the given choices
     * @param mixed $value
     * @return string A non-empty message if the values does not match the validation rules
     */
    public function validateVedhaeftningIndholdURLreferenceForChoiceConstraintsFromSetVedhaeftningIndholdURLreference($value): string
    {
        $message = '';
        if (is_null($value)) {
            return $message;
        ...
        try {
            foreach ($properties as $property) {
                if (isset($this->{$property})) {
                    throw new InvalidArgumentException(sprintf('The property VedhaeftningIndholdURLreference can\'t be set as the property %s is already set. Only one property must be set among these properties: VedhaeftningIndholdURLreference, %s.', $property, implode(', ', $properties)), __LINE__);
                }
            }
        } catch (InvalidArgumentException $e) {
            $message = $e->getMessage();
    ...
    public function setVedhaeftningIndholdURLreference(?string $vedhaeftningIndholdURLreference = null): self
    {
        ...
        // validation for constraint: choice(BilagIdentifikator, VedhaeftningIndholdData, VedhaeftningIndholdURLreference, VedhaeftSomIndholdDataIndikator)
        if ('' !== ($vedhaeftningIndholdURLreferenceChoiceErrorMessage = self::validateVedhaeftningIndholdURLreferenceForChoiceConstraintsFromSetVedhaeftningIndholdURLreference($vedhaeftningIndholdURLreference))) {
            throw new InvalidArgumentException($vedhaeftningIndholdURLreferenceChoiceErrorMessage, __LINE__);
        }
        if (is_null($vedhaeftningIndholdURLreference) || (is_array($vedhaeftningIndholdURLreference) && empty($vedhaeftningIndholdURLreference))) {
            unset($this->VedhaeftningIndholdURLreference);
        } else {
    ...
    {
        return isset($this->VedhaeftSomIndholdDataIndikator) ? $this->VedhaeftSomIndholdDataIndikator : null;
    }
    /**
     * This method is responsible for validating the value passed to the setVedhaeftSomIndholdDataIndikator method
     * This method is willingly generated in order to preserve the one-line inline validation within the setVedhaeftSomIndholdDataIndikator method
     * This has to validate that the property which is being set is the only one among the given choices
     * @param mixed $value
     * @return string A non-empty message if the values does not match the validation rules
     */
    public function validateVedhaeftSomIndholdDataIndikatorForChoiceConstraintsFromSetVedhaeftSomIndholdDataIndikator($value): string
    {
        $message = '';
        if (is_null($value)) {
            return $message;
        ...
        try {
            foreach ($properties as $property) {
                if (isset($this->{$property})) {
                    throw new InvalidArgumentException(sprintf('The property VedhaeftSomIndholdDataIndikator can\'t be set as the property %s is already set. Only one property must be set among these properties: VedhaeftSomIndholdDataIndikator, %s.', $property, implode(', ', $properties)), __LINE__);
                }
            }
        } catch (InvalidArgumentException $e) {
            $message = $e->getMessage();
    ...
    public function setVedhaeftSomIndholdDataIndikator(?bool $vedhaeftSomIndholdDataIndikator = null): self
    {
        ...
        // validation for constraint: choice(BilagIdentifikator, VedhaeftningIndholdData, VedhaeftningIndholdURLreference, VedhaeftSomIndholdDataIndikator)
        if ('' !== ($vedhaeftSomIndholdDataIndikatorChoiceErrorMessage = self::validateVedhaeftSomIndholdDataIndikatorForChoiceConstraintsFromSetVedhaeftSomIndholdDataIndikator($vedhaeftSomIndholdDataIndikator))) {
            throw new InvalidArgumentException($vedhaeftSomIndholdDataIndikatorChoiceErrorMessage, __LINE__);
        }
        if (is_null($vedhaeftSomIndholdDataIndikator) || (is_array($vedhaeftSomIndholdDataIndikator) && empty($vedhaeftSomIndholdDataIndikator))) {
            unset($this->VedhaeftSomIndholdDataIndikator);
        } else {
