...
class KanalUafhaengigeParametreIType extends AbstractStructBase
{
     ...
     * @var \ItkDev\OS2Forms_Digital_Post\PrintService\StructType\ForsendelseAfsenderType|null
     */
    protected ?\ItkDev\OS2Forms_Digital_Post\PrintService\StructType\ForsendelseAfsenderType $ForsendelseAfsender = null;
    /**
     ...
     * @param \ItkDev\OS2Forms_Digital_Post\PrintService\StructType\ForsendelseAfsenderType $forsendelseAfsender
     ...
     * @param string $enhedTekst
     * @return \ItkDev\OS2Forms_Digital_Post\PrintService\StructType\KanalUafhaengigeParametreIType
     */
     ...
     * @return \ItkDev\OS2Forms_Digital_Post\PrintService\StructType\ForsendelseAfsenderType|null
     */
    public function getForsendelseAfsender(): ?\ItkDev\OS2Forms_Digital_Post\PrintService\StructType\ForsendelseAfsenderType
    {
     ...
     * @return \ItkDev\OS2Forms_Digital_Post\PrintService\StructType\KanalUafhaengigeParametreIType
     */
    public function setForsendelseAfsender(?\ItkDev\OS2Forms_Digital_Post\PrintService\StructType\ForsendelseAfsenderType $forsendelseAfsender = null): self
    {
    ...
    /**
     * Set KanalKode value
     * @uses \ItkDev\OS2Forms_Digital_Post\PrintService\EnumType\KanalKodeType::valueIsValid()
     * @uses \ItkDev\OS2Forms_Digital_Post\PrintService\EnumType\KanalKodeType::getValidValues()
    ...
    public function setKanalKode(?string $kanalKode = null): self
    {
        ...
        if (!\ItkDev\OS2Forms_Digital_Post\PrintService\EnumType\KanalKodeType::valueIsValid($kanalKode)) {
