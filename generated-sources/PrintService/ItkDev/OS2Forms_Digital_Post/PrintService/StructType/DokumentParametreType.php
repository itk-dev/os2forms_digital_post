...
class DokumentParametreType extends AbstractStructBase
{
     ...
     * @var \ItkDev\OS2Forms_Digital_Post\PrintService\StructType\MeddelelsesFormatObjektType|null
     */
    protected ?\ItkDev\OS2Forms_Digital_Post\PrintService\StructType\MeddelelsesFormatObjektType $MeddelelsesFormatObjekt = null;
    /**
     ...
     * @param \ItkDev\OS2Forms_Digital_Post\PrintService\StructType\MeddelelsesFormatObjektType $meddelelsesFormatObjekt
     */
    public function __construct(?string $titelTekst = null, ?string $uUIDIdentifikator = null, ?string $brevDato = null, ?\ItkDev\OS2Forms_Digital_Post\PrintService\StructType\MeddelelsesFormatObjektType $meddelelsesFormatObjekt = null)
    {
        $this
     ...
     * @param string $titelTekst
     * @return \ItkDev\OS2Forms_Digital_Post\PrintService\StructType\DokumentParametreType
     */
     ...
     * @return \ItkDev\OS2Forms_Digital_Post\PrintService\StructType\MeddelelsesFormatObjektType|null
     */
    public function getMeddelelsesFormatObjekt(): ?\ItkDev\OS2Forms_Digital_Post\PrintService\StructType\MeddelelsesFormatObjektType
    {
     ...
     * @return \ItkDev\OS2Forms_Digital_Post\PrintService\StructType\DokumentParametreType
     */
    public function setMeddelelsesFormatObjekt(?\ItkDev\OS2Forms_Digital_Post\PrintService\StructType\MeddelelsesFormatObjektType $meddelelsesFormatObjekt = null): self
    {
