...
class PostParametreType extends AbstractStructBase
{
     ...
     * @uses \ItkDev\OS2Forms_Digital_Post\PrintService\EnumType\PostKategoriKodeType::valueIsValid()
     * @uses \ItkDev\OS2Forms_Digital_Post\PrintService\EnumType\PostKategoriKodeType::getValidValues()
     * @throws InvalidArgumentException
     * @param string $postKategoriKode
     * @return \ItkDev\OS2Forms_Digital_Post\PrintService\StructType\PostParametreType
     */
    public function setPostKategoriKode(?string $postKategoriKode = null): self
    {
        // validation for constraint: enumeration
        if (!\ItkDev\OS2Forms_Digital_Post\PrintService\EnumType\PostKategoriKodeType::valueIsValid($postKategoriKode)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \ItkDev\OS2Forms_Digital_Post\PrintService\EnumType\PostKategoriKodeType', is_array($postKategoriKode) ? implode(', ', $postKategoriKode) : var_export($postKategoriKode, true), implode(', ', \ItkDev\OS2Forms_Digital_Post\PrintService\EnumType\PostKategoriKodeType::getValidValues())), __LINE__);
        }
