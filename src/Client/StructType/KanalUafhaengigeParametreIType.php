...
class KanalUafhaengigeParametreIType extends AbstractStructBase
{
     ...
     * @var \Drupal\os2forms_digital_post\Client\StructType\ForsendelseAfsenderType|null
     */
    protected ?\Drupal\os2forms_digital_post\Client\StructType\ForsendelseAfsenderType $ForsendelseAfsender = null;
    /**
     ...
     * @param \Drupal\os2forms_digital_post\Client\StructType\ForsendelseAfsenderType $forsendelseAfsender
     ...
     * @return \Drupal\os2forms_digital_post\Client\StructType\ForsendelseAfsenderType|null
     */
    public function getForsendelseAfsender(): ?\Drupal\os2forms_digital_post\Client\StructType\ForsendelseAfsenderType
    {
     ...
     * @return \Drupal\os2forms_digital_post\Client\StructType\KanalUafhaengigeParametreIType
     */
    public function setForsendelseAfsender(?\Drupal\os2forms_digital_post\Client\StructType\ForsendelseAfsenderType $forsendelseAfsender = null): self
    {
    ...
    /**
     * Set KanalKode value
     * @uses \Drupal\os2forms_digital_post\Client\EnumType\KanalKodeType::valueIsValid()
     * @uses \Drupal\os2forms_digital_post\Client\EnumType\KanalKodeType::getValidValues()
    ...
    public function setKanalKode(?string $kanalKode = null): self
    {
        ...
        if (!\Drupal\os2forms_digital_post\Client\EnumType\KanalKodeType::valueIsValid($kanalKode)) {
