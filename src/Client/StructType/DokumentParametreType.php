...
class DokumentParametreType extends AbstractStructBase
{
     ...
     * @var \Drupal\os2forms_digital_post\Client\StructType\MeddelelsesFormatObjektType|null
     */
    protected ?\Drupal\os2forms_digital_post\Client\StructType\MeddelelsesFormatObjektType $MeddelelsesFormatObjekt = null;
    /**
     ...
     * @param \Drupal\os2forms_digital_post\Client\StructType\MeddelelsesFormatObjektType $meddelelsesFormatObjekt
     */
    public function __construct(?string $titelTekst = null, ?string $uUIDIdentifikator = null, ?string $brevDato = null, ?\Drupal\os2forms_digital_post\Client\StructType\MeddelelsesFormatObjektType $meddelelsesFormatObjekt = null)
    {
        $this
     ...
     * @param string $titelTekst
     * @return \Drupal\os2forms_digital_post\Client\StructType\DokumentParametreType
     */
     ...
     * @return \Drupal\os2forms_digital_post\Client\StructType\MeddelelsesFormatObjektType|null
     */
    public function getMeddelelsesFormatObjekt(): ?\Drupal\os2forms_digital_post\Client\StructType\MeddelelsesFormatObjektType
    {
     ...
     * @return \Drupal\os2forms_digital_post\Client\StructType\DokumentParametreType
     */
    public function setMeddelelsesFormatObjekt(?\Drupal\os2forms_digital_post\Client\StructType\MeddelelsesFormatObjektType $meddelelsesFormatObjekt = null): self
    {
